...
function PlaylistContent() {
  ...
  return (
    <div className="bg-neutral-900 h-full w-full overflow-hidden overflow-y-auto">
      <div className="gsyf5AkxvVEMilYkkHdr" style={{ background: "linear-gradient(rgb(160,56,0) 0%, transparent 100%)", padding: "1.5rem" }}>
      ...
      <div className="flex flex-col gap-y-1 p-4 md:p-6 text-neutral-400">
        <div className="grid grid-cols-[auto,1fr,auto] gap-x-4 items-center px-4 py-2 border-b border-neutral-800">
