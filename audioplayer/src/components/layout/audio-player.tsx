...
function AudioPlayerContent() {
  ...
  const [currentTrack, setCurrentTrack] = useState<Audio | null>(initialTrack);
  ...
  useEffect(() => {
    ...
    if(searchParams.get('autoplay') === 'true' && audio.readyState >= 2) playAudio();
      ...
      <div className={styles.playerContent}>
        ...
        <div className={styles.playerControlsContainer}>
          <div id="smp-wrapper" className="sc-c-smp">
            <div id="smphtml5iframesmp-wrapperwrp" style={{ position: 'relative', zIndex: 999, height: '100%', width: '100%', paddingBottom: 0 }}>
              <div className={styles.progressContainer}>
                <div className={`${styles.playerSeekBarHolder}`} onMouseDown={handleMouseDown}>
                  ...
                  <div className={styles.bar} ref={progressBarRef}>
                    <div className={styles.progressBar} style={{ width: `${duration > 0 ? (currentTime / duration) * 100 : 0}%` }}>
                ...
                <button className={`${styles.audioButton}`} id="p_audioui_previousButton" aria-label="Previous item" >
                  ...
                  <button className={`${styles.audioButton} ${isPlaying ? styles.playing : ''}`} id="p_audioui_playpause" aria-label={isPlaying ? "Pause" : "Play"} onClick={togglePlayPause}>
                  ...
                  <button className={`${styles.audioButton}`} id="p_audioui_nextButton" aria-label="Next item">
                    <div className="p_audioButton_buttonInner">
